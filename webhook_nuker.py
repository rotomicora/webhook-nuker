...
"""
os.system("@mode con cols=150, lines=45 & cls & title Webhook Nuker v1.0") # Definimos el tamaño de la terminal, limpiamos la terminal y asignamos un titulo a la terminal
